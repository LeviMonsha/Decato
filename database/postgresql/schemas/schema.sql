...
('f1a2b3c4-5678-4abc-8def-000000000001', 'Титаник: Машинное обучение на основе катастрофы', 'Предсказать выживание на Титанике и познакомиться с основами машинного обучения.', '', '2025-06-01T00:00:00+00', '2025-07-01T23:59:59+00', 3, TRUE),
('f1a2b3c4-5678-4abc-8def-000000000002', 'Цены на дома: Продвинутые методы регрессии', 'Предсказать цены продаж и попрактиковаться в продвинутых моделях регрессии.', '', '2025-07-15T00:00:00+00', '2025-08-15T23:59:59+00', 6, TRUE),
('f1a2b3c4-5678-4abc-8def-000000000003', 'Распознавание цифр', 'Определить цифры на рукописных изображениях с помощью компьютерного зрения.', '', '2025-08-01T00:00:00+00', '2025-09-01T23:59:59+00', 5, TRUE),
('f1a2b3c4-5678-4abc-8def-000000000004', 'Длительность поездок на такси в Нью-Йорке', 'Предсказать длительность поездок на такси в Нью-Йорке, используя временные ряды и геопространственные данные.', '', '2025-09-10T00:00:00+00', '2025-10-10T23:59:59+00', 7, FALSE),
('f1a2b3c4-5678-4abc-8def-000000000005', 'Тестовое соревнование', 'Для новичков', '', '2023-02-10T00:00:00+00', '2028-10-10T23:59:59+00', 1, TRUE);
